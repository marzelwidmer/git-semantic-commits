...
if [[ -n $1 ]] && [[ $1 == '--scripts' ]]; then
  ...
  semantic_aliases=( 'chore' 'docs' 'feat' 'fix' 'localize' 'chore' 'refactor' 'style' 'test' 'perf' )
...
echo 'See: https://github.com/marzelwidmer/git-semantic-commits for more information.'
